		...
		<div class="row">
			...
			<div class="col content-holder">
				...
				<div class="col-12 content-body my-3 py-3">
					<div class="row">
						<div class="col">
							<h1><i class="zmdi zmdi-alert-triangle"></i> <?php echo $title; ?></h1>
						</div>
						<div class="col-12">
							<table class="table table-striped table-hover">
								...
								<tbody>
									<?php
										...
										$sql = "SELECT * FROM reports ORDER BY created_at DESC LIMIT {$offset},{$limit}";
										$result = db_query($con, $sql);
									...
									?>
									<?php while($report = db_fetch_assoc($result)): ?>
										<?php $comment = db_fetch_assoc(db_query($con, "SELECT * FROM comments WHERE id = '{$report['comment_id']}'")); ?>
										<tr>
											<td><?php echo $n; $n++; ?></td>
											...
											<td>
												...
												<a href="<?php echo url('admin/report-delete.php?id='.$comment['id']); ?>" data-toggle="tooltip" title="Delete this item" class="delete"><i class="zmdi zmdi-delete"></i></a>
											</td>
										</tr>
									<?php endwhile; ?>
									<?php else: ?>
						...
						<div class="col-12">
							<nav>
							  <ul class="pagination">
							  	...
							  	<?php if($page_no > 1): ?>
							    <li class="page-item">
							      <a class="page-link" href="<?php echo url('admin/reports.php?p='.($page_no - 1)); ?>"><i class="zmdi zmdi-chevron-left"></i></a>
							    </li>
								<?php else: ?>
								...
								<?php else: ?>
								<li class="page-item">
							      <a class="page-link" href="<?php echo url('admin/reports.php?p='.$i); ?>"><?php echo $i; ?></a>
							    </li>
								<?php endif; ?>	
								<?php endfor; ?>
							    ...
							    <li class="page-item">
							      <a class="page-link" href="<?php echo url('admin/reports.php?p='.($page_no + 1)); ?>"><i class="zmdi zmdi-chevron-right"></i></a>
							    </li>
								<?php else: ?>
								<li class="page-item disabled">
